...
import { activateSnackBar, setUserToken } from "../Redux/actions"
import {resetData} from "../Data/Fetch"
...
function ResponsiveDrawer(props) {
  ...
  const handleDrawerToggle = () => {
    ...
    const handleLogOut = () =>
    {
        ...
        props.activateSnackBar({isError: false, message: "Logged out!"})
    ...
    const handleReset = async () =>
    {
        ...
        if ( !result.message ) {
            props.activateSnackBar({isError: false, message: "Data is resetted!"})
        }
    }
